...
import com.systeminfos.shardingJdbc31.mapper.UserInfoMapper;
...
//@SpringBootTest(classes = ShardJdbc31Application.class, properties = "spring.config.location=classpath:application.yml")
//@SpringBootTest(classes = ShardJdbc31Application.class,properties = "spring.config.location=classpath:application-dev.yml")
//@SpringBootTest(classes = ShardJdbc31Application.class,properties = "spring.config.location=classpath:application-dev-inline.yml")
@SpringBootTest(classes = ShardJdbc31Application.class,properties = "spring.config.location=classpath:application-prod.yml")
@Slf4j
public class ShardJdbc31ApplicationTests {
